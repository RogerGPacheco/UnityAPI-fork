...
public class CreateAccountController : MonoBehaviour
{
    ...
    public TMP_InputField txtConfirmSenha;
    ...
    public void ExibirSenha(TMP_InputField txt)
    {
    ...
    void Start()
    {
        ...
        txtConfirmSenha.contentType = TMP_InputField.ContentType.Password;
    }
    ...
    public void CreateAccount()
    {
        UserCreateRequest userCreateRequest = new UserCreateRequest
        {
            ...
            confirmPassword = txtConfirmSenha.text,
        };
